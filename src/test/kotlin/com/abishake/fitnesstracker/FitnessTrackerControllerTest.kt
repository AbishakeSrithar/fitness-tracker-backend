...
//        )
//
//        every { genericeService.getAllEntries() } returns entries
//
...
//    }
    ...
    fun myFirstControllerTest() {
        ...
        every { genericService.getAllWorkouts() } returns workouts
    ...
    fun mySecondControllerTest() {
        ...
        every { genericService.getAllExercises() } returns exercises
